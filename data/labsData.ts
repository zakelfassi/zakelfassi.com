...
const labsData: Lab[] = [
  ...
  //   imgSrc: '/static/images/labs/TAC.png',
  //   href: 'https://theaicoach.com',
  //   type: 'Products & Companies',
  // },
  {
    title: 'INK + PORCELAIN',
    description: `Artful Objects Designed by Women – An interior design and curation platform for creatives. Co-founder, and Chief Innovation Officer.`,
    imgSrc: '/static/images/labs/Inkandporcelain.png',
    href: 'https://www.inkandporcelain.com',
    type: 'Products & Companies',
  },
  {
    title: 'Zaigood Labs',
    description: `An experimental frontier technology lab supporting ideas and entrepreneurs making a difference in the world, and beyond. AI, Quantum Computing, Defense, Space, and a few things in between.`,
    imgSrc: '/static/images/labs/Zaigood.png',
    href: 'https://zaigood.com',
    type: 'Products & Companies',
  },
  {
    title: 'TalkAndComment',
    description: `Designed, built, and shipped (2013) a Chrome extension and (RIP) Android app that allows you to leave voice comments anywhere on the internet. It's 2024 and it's still alive and kicking. I'm figuring out why is that.`,
    imgSrc: '/static/images/labs/TalkAndComment.png',
  ...
  },
  {
    ...
    imgSrc: '/static/images/labs/ExplainAI.png',
  ...
  },
  {
    ...
    imgSrc: '/static/images/labs/AfricaDeepTechCommunity.png',
  ...
  },
  {
    ...
    imgSrc: '/static/images/labs/JobFinder.png',
    href: '#',
    type: 'Past',
  },
  {
    ...
    imgSrc: '/static/images/labs/send.png',
    href: '#',
    type: 'Past',
  },
  {
    ...
    imgSrc: '/static/images/labs/Libertweet.png',
    href: '#',
    type: 'Past',
  },
  {
    ...
    imgSrc: '/static/images/labs/FitHeat.png',
    href: '#',
    type: 'Past',
  },
  {
    ...
    imgSrc: '/static/images/labs/VoIPDown.png',
  ...
  },
  {
    ...
    imgSrc: '/static/images/labs/WannaJo.in.png',
    href: '#',
    type: 'Past',
  },
  {
    ...
    imgSrc: '/static/images/labs/PeaceNLol.png',
    href: '#',
    type: 'Past',
  },
  {
    ...
    imgSrc: '/static/images/labs/Concep.ma.png',
    href: '#',
    type: 'Past',
  },
]
